...
\subsection{Choix des meilleurs movements}
\subsubsection{BFS}
Pour pouvoir calculer les meilleurs movements, nous avons utilisé un Parcours en largeur (Breadth First Search : BFS) sur chacune des cases du plateaux. 
Le principe est de 
